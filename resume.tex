...
\section{\faLaptopCode}{Experience / Projects}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
	  ...
	  \resumeItem{
		Designed microcontroller and programmable logic device hardware and software
		subsystems for integration into larger projects
	  }

	  \resumeItem{
		Participated in decomposition of project requirements with a systems engineering
		team
	  }
