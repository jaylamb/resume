  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{
		...
		design description [HDD] and software design description [SDD]), in
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{
		...
		blade imbalance, and tip path track testing
	  }
 ...
 \resumeEntryStart
  \resumeEntryS
	{Embedded Hardware}
	{
	 ...
	 device creation in EAGLE, test hardware design, interface design (I\textsuperscript{2}C, SPI, RS-232)
	}
  ...
  \resumeEntryNote{
	...
	Investigation/Periodic Review completed on 11/22/3333.
  }
